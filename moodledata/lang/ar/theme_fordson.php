...
$string['courseboxheight_desc'] = 'التحكم في ارتفاع بلاطة المقررات الدراسية في الصفحة الأولى وفي تصنيفات المقررات الدراسية.';
...
$string['coursetileinfodesc'] = 'تتيح لك هذه الإعدادات تخصيص كيفية عرض المقررات الدراسية على الصفحة الأمامية وكذلك تصنيفات المقررات الدراسية.';
...
$string['marketingheadingsub'] = 'ثلاثة مواضع في الصفحة الأمامية لإضافة المعلومات والروابط';
...
$string['marketingicondesc'] = 'اسم الأيقونة التي ترغب باستعمالها في عنوان نقاط التسويق. القائمة تجدها <a href="https://fontawesome.com/v4.7.0/icons/" target="_new">هنا</a>.  أدخل فقط ما تجده بعد "fa-".';
