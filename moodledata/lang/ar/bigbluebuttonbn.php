...
$string['bigbluebuttonbn:addinstance'] = 'هذه الجلسة هي إضافة غرفة / نشاط غرفة اجتماعات BBB جديد
تم تسجيل نانوغرام من البداية.';
...
$string['config_lockonjoinconfigurable_editable'] = 'تهيئة التأمين يمكن تحريره';
$string['config_lockonjoinconfigurable_editable_description'] = 'يمكن تعديل تكوين القفل إفتراضيًا عند إضافة المثيل أو تحديثه.';
...
$string['config_presentation_default'] = 'الملف الافتراضي لميزة "التحميل المسبق للعرض التقديمي"';
$string['config_presentation_default_description'] = 'يسمح هذا الإعداد بتحديد ملف لاستخدامه كملف تلقائي
 في جميع حالات غرف اجتماعات  BBB إذا تم تمكين "العرض التقديمي للتحميل المسبق".';
$string['config_preuploadpresentation'] = 'الاعدادات لميزة "التحميل المسبق للعرض التقديمي"';
...
$string['config_preuploadpresentation_enabled'] = 'تم تمكين التحميل المسبق للعرض التقديمي';
$string['config_preuploadpresentation_enabled_description'] = 'يتم تمكين ميزة التحميل المسبق للعرض التقديمي في واجهة المستخدم عند إضافة أو تحديث الغرفة أو المؤتمر.';
...
$string['config_recordings_preview_default_description'] = 'في حالة التمكين ، يتضمن الجدول معاينة للعرض التقديمي.';
...
$string['config_waitformoderator_ping_interval_description'] = 'عند تمكين ميزة انتظار المشرف ، يقوم المستخدم باختبار حالة الجلسة كل [كذا] ثانية. تحدد هذه المعلمة الفاصل الزمني للطلبات المقدمة إلى خادم Moodle';
$string['config_warning_bigbluebuttonbn_cfg_deprecated'] = 'تستعمل غرف اجتماعات BBB من الملف config.php مع متغير عمومي تم إهماله. يرجى تحويل الملف لأنه لن يتم دعمه في الإصدارات المستقبلية.';
...
$string['index_heading_moderator'] = 'مديرو الجلسة';
$string['index_heading_name'] = 'الغرفة';
$string['index_heading_recording'] = 'التسجيل';
$string['index_heading_users'] = 'المستخدمون';
$string['index_heading_viewer'] = 'المشاهدون';
$string['indicator:cognitivedepth'] = 'غرف اجتماعات BBB معرفياً';
$string['indicator:cognitivedepth_help'] = 'هذا المؤشر مبني على عمق الحالة المعرفية التي وصلها الطالب في نشاط غرف اجتماعات BBB.';
$string['indicator:socialbreadth'] = 'غرف اجتماعات BBB إجتماعياً';
$string['indicator:socialbreadth_help'] = 'هذا المؤشر مبني على عمق التوسع الاجتماعي الذي وصله الطالب في نشاط غرف اجتماعات BBB.';
$string['instance_type_default'] = 'غرفة / نشاط مع تسجيلات';
...
$string['mod_form_field_closingtime'] = 'تم إغلاق الانضمام';
...
$string['mod_form_field_instanceprofiles'] = 'نوع العيِّنة';
$string['mod_form_field_instanceprofiles_help'] = 'حدّد النوع لمثيل غرف اجتماعات BBB هذا.';
...
$string['mod_form_field_participant_bbb_role_moderator'] = 'المشرف';
...
$string['mod_form_field_participant_list_type_all'] = 'تم ضم جميع المستخدمين';
...
$string['modulename'] = 'غرفة اجتماعات BBB';
$string['modulename_help'] = 'تتيح لك غرف اجتماعات BBB إنشاء روابط من داخل مودل للفصول الدراسية عبر الإنترنت في الوقت الفعلي باستعمال غرف اجتماعات BBB، وهو نظام مؤتمرات ويب مفتوح المصدر للتعليم عن بعد.

باستعمال غرف اجتماعات BBB، يمكنك تحديد العنوان والوصف وإدخال التقويم (الذي يوفر نطاقًا زمنيًا للانضمام إلى الجلسة) والمجموعات والتفاصيل حول تسجيل الجلسة عبر الإنترنت.';
$string['modulenameplural'] = 'غرف اجتماعات BBB';
$string['pluginadministration'] = 'إدارة غرف اجتماعات BBB';
$string['pluginname'] = 'غرف اجتماعات BBB';
...
$string['search:activity'] = 'غرف اجتماعات BBB - معلومات النشاط';
$string['search:tags'] = 'غرف اجتماعات BBB - معلومات الوسوم';
...
$string['view_login_moderator'] = 'الدخول بصفة مدير الجلسة ...';
...
$string['view_message_conference_wait_for_moderator'] = 'بانتظار انضمام مديرالجلسة';
...
$string['view_message_moderator'] = 'مدير الجلسة';
$string['view_message_moderators'] = 'مديرو الجلسة';
$string['view_message_norecordings'] = 'ليس هناك تسجيل لإظهاره.';
$string['view_message_notavailableyet'] = 'هذه الجلسة غير متاحة بعد.';
$string['view_message_recordings_disabled'] = 'تم تعطيل التسجيلات على هذا الخادم. لا يمكن استخدام مثيلات غرف اجتماعات BBB للتسجيلات فقط.';
...
$string['view_noguests'] = 'غرف اجتماعات BBB غير مفتوحة للضيوف';
