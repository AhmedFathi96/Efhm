...
--
-- Table structure for table `cocoon_enrol_lti_lti2_consumer`
--

DROP TABLE IF EXISTS `cocoon_enrol_lti_lti2_consumer`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_enrol_lti_lti2_consumer` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `cocoon_enroltilti2cons_con_uix` (`consumerkey256`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPRESSED COMMENT='LTI consumers interacting with moodle';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_enrol_lti_lti2_consumer`
--

LOCK TABLES `cocoon_enrol_lti_lti2_consumer` WRITE;
/*!40000 ALTER TABLE `cocoon_enrol_lti_lti2_consumer` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_enrol_lti_lti2_consumer` ENABLE KEYS */;
UNLOCK TABLES;
