...
--
-- Table structure for table `cocoon_enrol_lti_tools`
--

DROP TABLE IF EXISTS `cocoon_enrol_lti_tools`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_enrol_lti_tools` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_enroltitool_enr_ix` (`enrolid`),
  KEY `cocoon_enroltitool_con_ix` (`contextid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='List of tools provided to the remote system';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_enrol_lti_tools`
--

LOCK TABLES `cocoon_enrol_lti_tools` WRITE;
/*!40000 ALTER TABLE `cocoon_enrol_lti_tools` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_enrol_lti_tools` ENABLE KEYS */;
UNLOCK TABLES;
