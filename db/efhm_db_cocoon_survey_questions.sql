...
--
-- Table structure for table `cocoon_survey_questions`
--

DROP TABLE IF EXISTS `cocoon_survey_questions`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_survey_questions` (
