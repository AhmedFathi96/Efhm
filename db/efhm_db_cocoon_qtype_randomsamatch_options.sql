...
--
-- Table structure for table `cocoon_qtype_randomsamatch_options`
--

DROP TABLE IF EXISTS `cocoon_qtype_randomsamatch_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_qtype_randomsamatch_options` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `cocoon_qtyprandopti_que_uix` (`questionid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Info about a random short-answer matching question';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_qtype_randomsamatch_options`
--

LOCK TABLES `cocoon_qtype_randomsamatch_options` WRITE;
/*!40000 ALTER TABLE `cocoon_qtype_randomsamatch_options` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_qtype_randomsamatch_options` ENABLE KEYS */;
UNLOCK TABLES;
