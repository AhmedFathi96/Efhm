...
--
-- Table structure for table `cocoon_feedback`
--

DROP TABLE IF EXISTS `cocoon_feedback`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_feedback` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_feed_cou_ix` (`course`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='all feedbacks';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_feedback`
--

LOCK TABLES `cocoon_feedback` WRITE;
/*!40000 ALTER TABLE `cocoon_feedback` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_feedback` ENABLE KEYS */;
UNLOCK TABLES;
