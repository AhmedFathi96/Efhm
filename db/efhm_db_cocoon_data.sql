...
--
-- Table structure for table `cocoon_data`
--

DROP TABLE IF EXISTS `cocoon_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_data` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_data_cou_ix` (`course`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPRESSED COMMENT='all database activities';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_data`
--

LOCK TABLES `cocoon_data` WRITE;
/*!40000 ALTER TABLE `cocoon_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_data` ENABLE KEYS */;
UNLOCK TABLES;
