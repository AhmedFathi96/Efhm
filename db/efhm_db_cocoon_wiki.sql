...
--
-- Table structure for table `cocoon_wiki`
--

DROP TABLE IF EXISTS `cocoon_wiki`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_wiki` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_wiki_cou_ix` (`course`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Stores Wiki activity configuration';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_wiki`
--

LOCK TABLES `cocoon_wiki` WRITE;
/*!40000 ALTER TABLE `cocoon_wiki` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_wiki` ENABLE KEYS */;
UNLOCK TABLES;
