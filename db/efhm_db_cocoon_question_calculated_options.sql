...
--
-- Table structure for table `cocoon_question_calculated_options`
--

DROP TABLE IF EXISTS `cocoon_question_calculated_options`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_question_calculated_options` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_quescalcopti_que_ix` (`question`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Options for questions of type calculated';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_question_calculated_options`
--

LOCK TABLES `cocoon_question_calculated_options` WRITE;
/*!40000 ALTER TABLE `cocoon_question_calculated_options` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_question_calculated_options` ENABLE KEYS */;
UNLOCK TABLES;
