...
--
-- Table structure for table `cocoon_mnet_remote_rpc`
--

DROP TABLE IF EXISTS `cocoon_mnet_remote_rpc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_mnet_remote_rpc` (
