...
--
-- Table structure for table `cocoon_quizaccess_seb_quizsettings`
--

DROP TABLE IF EXISTS `cocoon_quizaccess_seb_quizsettings`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_quizaccess_seb_quizsettings` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `cocoon_quizsebquiz_qui_uix` (`quizid`),
  UNIQUE KEY `cocoon_quizsebquiz_cmi_uix` (`cmid`),
  KEY `cocoon_quizsebquiz_tem_ix` (`templateid`),
  KEY `cocoon_quizsebquiz_use_ix` (`usermodified`)
...
--
-- Dumping data for table `cocoon_quizaccess_seb_quizsettings`
--

LOCK TABLES `cocoon_quizaccess_seb_quizsettings` WRITE;
/*!40000 ALTER TABLE `cocoon_quizaccess_seb_quizsettings` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_quizaccess_seb_quizsettings` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-05-17 19:00:56
