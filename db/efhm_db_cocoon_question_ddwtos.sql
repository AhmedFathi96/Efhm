...
--
-- Table structure for table `cocoon_question_ddwtos`
--

DROP TABLE IF EXISTS `cocoon_question_ddwtos`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_question_ddwtos` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_quesddwt_que_ix` (`questionid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Defines drag and drop (words into sentences) questions';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_question_ddwtos`
--

LOCK TABLES `cocoon_question_ddwtos` WRITE;
/*!40000 ALTER TABLE `cocoon_question_ddwtos` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_question_ddwtos` ENABLE KEYS */;
UNLOCK TABLES;
