...
--
-- Table structure for table `cocoon_qtype_ddmarker`
--

DROP TABLE IF EXISTS `cocoon_qtype_ddmarker`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_qtype_ddmarker` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_qtypddma_que_ix` (`questionid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Defines drag and drop (text or images onto a background imag';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_qtype_ddmarker`
--

LOCK TABLES `cocoon_qtype_ddmarker` WRITE;
/*!40000 ALTER TABLE `cocoon_qtype_ddmarker` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_qtype_ddmarker` ENABLE KEYS */;
UNLOCK TABLES;
