...
--
-- Table structure for table `cocoon_glossary`
--

DROP TABLE IF EXISTS `cocoon_glossary`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_glossary` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_glos_cou_ix` (`course`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='all glossaries';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_glossary`
--

LOCK TABLES `cocoon_glossary` WRITE;
/*!40000 ALTER TABLE `cocoon_glossary` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_glossary` ENABLE KEYS */;
UNLOCK TABLES;
