...
--
-- Table structure for table `cocoon_quiz`
--

DROP TABLE IF EXISTS `cocoon_quiz`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_quiz` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_quiz_cou_ix` (`course`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='The settings for each quiz.';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_quiz`
--

LOCK TABLES `cocoon_quiz` WRITE;
/*!40000 ALTER TABLE `cocoon_quiz` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_quiz` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-05-17 19:00:39
