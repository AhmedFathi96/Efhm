...
--
-- Table structure for table `cocoon_choice`
--

DROP TABLE IF EXISTS `cocoon_choice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_choice` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_choi_cou_ix` (`course`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Available choices are stored here';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_choice`
--

LOCK TABLES `cocoon_choice` WRITE;
/*!40000 ALTER TABLE `cocoon_choice` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_choice` ENABLE KEYS */;
UNLOCK TABLES;
