...
--
-- Table structure for table `cocoon_question_gapselect`
--

DROP TABLE IF EXISTS `cocoon_question_gapselect`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_question_gapselect` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_quesgaps_que_ix` (`questionid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Defines select missing words questions';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_question_gapselect`
--

LOCK TABLES `cocoon_question_gapselect` WRITE;
/*!40000 ALTER TABLE `cocoon_question_gapselect` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_question_gapselect` ENABLE KEYS */;
UNLOCK TABLES;
