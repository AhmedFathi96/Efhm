...
--
-- Table structure for table `cocoon_resource`
--

DROP TABLE IF EXISTS `cocoon_resource`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cocoon_resource` (
  ...
  PRIMARY KEY (`id`),
  KEY `cocoon_reso_cou_ix` (`course`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Each record is one resource and its config data';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cocoon_resource`
--

LOCK TABLES `cocoon_resource` WRITE;
/*!40000 ALTER TABLE `cocoon_resource` DISABLE KEYS */;
/*!40000 ALTER TABLE `cocoon_resource` ENABLE KEYS */;
UNLOCK TABLES;
